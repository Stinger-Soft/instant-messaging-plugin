...
public class BuildCommandTest {
    ...
    private BuildableItemDelegator project;
    ...
    public void testDelay() {
        ...
        BuildableItemDelegator project = mockProject(jobProvider);
    ...
    private BuildableItemDelegator mockProject(JobProvider jobProvider) {
        @SuppressWarnings("rawtypes")
        BuildableItemDelegator tmpProject = mock(BuildableItemDelegator.class);
        when(jobProvider.getJobByNameOrDisplayName(Mockito.anyString())).thenReturn(tmpProject);
        when(tmpProject.hasPermission(Item.BUILD)).thenReturn(Boolean.TRUE);
        when(tmpProject.isBuildable()).thenReturn(true);
        return tmpProject;
    }
    ...
    private BuildCommandTest givenAParametrizedProject() {
        this.project = mock(BuildableItemDelegator.class);
